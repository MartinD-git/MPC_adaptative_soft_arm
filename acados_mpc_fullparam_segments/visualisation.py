...
out_dir = "csv_and_plots_adaptative/"
SAVE = False
...
def history_plot(pcc_arm,u_bound,xyz_traj=None):
    ...
    if SAVE:
        ...
        np.savetxt(out_dir + "history_pred.csv", history_pred, delimiter=",")
    ...
    ax.legend(labels=[r'$\phi_1$', r'$\theta_1$', r'$\phi_2$', r'$\theta_2$',
                    r'$\dot{\phi}_1$', r'$\dot{\theta}_1$', r'$\dot{\phi}_2$', r'$\dot{\theta}_2$'])
    fig.tight_layout()
